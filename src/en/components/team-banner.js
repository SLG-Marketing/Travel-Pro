...
export default class TravelProTeamBannerEN extends HTMLElement {

  connectedCallback() {
    this.innerHTML = `<div class="tp-section pb-0" style="background-image: url('${background}')">
                        <div class="tp-container text-center">
                          <h2 class="tp-heading tp-heading--h2 mb-24 color-white">Get in touch with the Travel Pro specialist !</h2>
...
customElements.define('tp-team-banner-en', TravelProTeamBannerEN);