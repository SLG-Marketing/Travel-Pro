                        ...
                        <div class="tp-header__row-1">
                          <div class="tp-container">
                            ...
                            <div class="tp-header__row-1__right">
                                ...
                                <li tabindex="0">
                                  ...
                                  <ul>
                                    <li><a href="${
                                      ...
                                      ? '../../en/articles/28-days-holiday-with-6-days-off.html'
                                      : '' 
                              ...
                              <a href="${this._url}/request-demo.html" class="tp-button tp-button--primary h-xs d-f-sm h-lg">Demander une démo</a>
                            ...
                            <div class="tp-header__row-2__left">
                              <nav class="tp-nav">
                                <ul>
                                  ...
                                  <li class="tp-nav__item ${this._active === 'about-us' ? `tp-nav__item--selected` : ''}"><a href="${this._url}/nous.html">À propos de nous</a></li>
                              ...
                              <div class="tp-sub-nav">
                                <a href="https://www.slg.lu/career/" target="_blank" class="tp-link h-lg">Carrières <i class="icon-arrow-up-right-from-square" aria-hidden="true"></i></a>
                                <a href="${this._url}/request-demo.html" class="tp-button tp-button--primary h-sm">Demander une démo</a>
                              </div>
                            </div>
                            <div class="tp-header__row-2__right d-lg">
                              <a href="${this._url}/request-demo.html" class="tp-button tp-button--primary" id="content">Demander une démo</a>
                            </div>
                          </div>
                        </div>
                      </header>`;
